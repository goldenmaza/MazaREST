 ...
 */
public class AccountDefault extends ServerResource {
    @Get
    // Return the GET request with JSON data, filtered...
    public Representation getAccountTable() throws JSONException {
    	List<JSONObject> bankAccounts = AccountData.getFilteredBankAccounts();
